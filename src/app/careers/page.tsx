...
export default function CareersPage() {
  ...
  const handleOpenDetail = (item: WorkItem) => {
    setSelected(item);
    router.replace(`/careers?id=${item.id}`);
  };
  ...
  return (
    <>
      ...
      <main className="bg-white min-h-screen">
        <Hero title="Careers" subtitle="Where all our great things begin" bgImage="/grey.jpeg" />
              ...
              <div className="w-full max-w-3xl mx-auto">
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html:
                      selected.content
                        ? selected.content.replace(/<p/g, '<p style="margin-bottom:1rem"')
                        : "Tidak ada konten.",
                  }}
                />
              </div>
